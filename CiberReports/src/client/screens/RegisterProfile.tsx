        ...
        <>
            ...
            <div className="container mx-auto flex items-center justify-center">
                ...
                <div className=" h-auto  ax-w-sm p-6 bg-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <h1 className=" text-center text-black font-bold text-4xl mb-0">Regist your profile</h1>
                        ...
                        <div>
                            <form >
                                ...
                                <div className="grid gap-6 mb-6 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            id="file_input"
                                            onChange={(e) => {
                                                uploadBanner(e); // 👈 this will trigger when user selects the file.
                                            }} />
                                    </div>
                                    <div>
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <Link to={"/"}><button type="submit" className=" mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button></Link>
