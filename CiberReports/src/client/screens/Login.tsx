                ...
                <div className=" xl:w-[580px;] xl:h-[640px] bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                  <form className="space-y-6" action="#">
                    ...
                    <div className="text-sm text-center font-medium text-gray-500 dark:text-gray-300">
                      If you don't have an account?<Link to="/register" className="text-blue-700 hover:underline dark:text-blue-500"><span className="text-darkAqua">Register</span></Link>
                    </div>
                    <div>
