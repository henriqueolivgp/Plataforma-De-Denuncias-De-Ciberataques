        ...
        <div className="content w-full ">
          ...
          <div className=' bg-gray-200 p-8'>
            <a href="#" className='text-lg'>
              ...
              ipsum maiores quidem consequatur facilis ipsam sunt dolor, iste nobis deserunt 
              suscipit quasi labore iusto non quo minima odio tempora!
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ab esse voluptatum 
              sint quam quia veritatis odit alias maiores eos ex sapiente enim exercitationem, v
              oluptatibus ea cum odio quis, itaque saepe.
            </a>
          </div>
          <div>
            <h1 className='text-2xl font-bold flex justify-center mt-16'>Developers:</h1>
          </div>
          <div className='flex justify-center mt-12 mb-12 rounded space-x-5'>
            ...
            <div className="w-60 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="flex flex-col items-center pb-10">
                <img className="w-24 h-24 mb-3 rounded-full " src="#" alt="Dev image" />
                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Developer</h5>
                <span className="text-sm font-bold text-gray-500 dark:text-gray-400">Desenvolvedor & CEO</span>
                <button type="button" className="rounded-lg mt-4 px-3 py-2 text-sm font-medium text-center inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  <svg className="w-3 h-3 text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
                    <path d="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 18 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z" />
