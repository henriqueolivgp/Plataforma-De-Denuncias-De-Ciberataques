    ...
    <nav className="bg-transparent dark:bg-gray-800 dark:border-gray-700 ">
      <div className=" flex flex-1 items-center p-4 justify-between ">
        ...
        <div className='flex flex-1 items-center'>
          <div className=" md:w-auto ml-auto mr-5" id="navbar-solid-bg" ref={menuRef}>
            {!session && (
              <button data-collapse-toggle="navbar-solid-bg"
              onClick={handleClick} 
              type="button" 
              className="lgg:hidden  p-2 w-10 h-10 text-sm text-gray-500 rounded-lg flex hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" 
            ...
            <ul className="lgg:flex flex-col hidden  font-medium rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
              <li className="block">
            ...
            <div ref={menuRef} className="relative">
              ...
              >
                ...
                <ul className="py-2" aria-labelledby="user-menu-button">
                  ...
                  <li>
                    <Link to='profile/reports' className="flex items-center p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <li>
                    <Link to='profile/chat' className="flex items-center p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
