              ...
              <div className="relative">
                ...
                >
                  ...
                  <ul className="py-2" aria-labelledby="user-menu-button">
                    <li>
                      <Link to='/profile' className="flex items-center p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                      ...
                      <Link to='/settings' className="flex items-center p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
